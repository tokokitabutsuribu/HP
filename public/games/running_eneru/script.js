...
function setCanvasSize(){
    ...
    if (vw>1250) {
        ...
        cvs.width=`${vw-50}`;
        cvs.height=`${(vw-50)*350/1200}`;
        ctx.scale((vw-50)/1200,(vw-50)/1200);
    }
}
...
player[0].src="imgs/players/eneru_monochrome_256px.png";
player[1].src="imgs/players/eneru_death.png";
player[2].src="imgs/players/eneru_fallen.png";
meteor_img.src="imgs/meteor.png";
logo.src="imgs/logo.png";

player_walk[0].src="imgs/players/eneru_walk_1.png";
player_walk[1].src="imgs/players/eneru_walk_2.png";
hand_raised_player_walk[0].src="imgs/players/eneru_handsUp_1.png";
hand_raised_player_walk[1].src="imgs/players/eneru_handsUp_2.png";

obstacle_img[0].src="imgs/obstacles/theCurseOfTheOhmu.png";
obstacle_img[1].src="imgs/obstacles/schrodinger'sCat_1.png";
obstacle_img[2].src="imgs/obstacles/telekinesis_vector.png";
obstacle_img[3].src="imgs/obstacles/hurdle.png";
